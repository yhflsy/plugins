...
return array(
    'linequery' =>array(
        'linegrade' => array(0 =>'不限',1 => '跟团游',2 => '自由行', 3 => '自驾游', 4 => '邮轮'),
        ...
        'lineprice' => array(0 =>'不限',1 => '0-500',2 => '500-1000',3 => '1000-2000', 4 => '2000-4000', 5 => '4000-6000', 6 => '6000以上'),
        ...
        'linecategory' => array(0 => '周边游',1 =>'国内游',2=> '出境游'),
    ),
    'statistics' => array(
    ...
    'traffic' => array(
        'trafficisback' => array(3 =>'不限',0 =>'往', 1 => '返', 2 => '往返'),
    ...
    'order' => array(
        'state' => array( 1 => '名单不全', 2 => '未确认', 3 => '已确认', 4 => '退款', 5 => '取消', 6 => '已出票',7 =>'供应商未确认',8=>'供应商已确认'),
        ...
        'selfStatus' => array(6 => '未付款',7 => '已支付(线下)/未结算', 8 => '已支付(线下)/已结算',0 => '已支付(线上)/未结算',1 => '已支付(线上)/已结算',4 => '已退单/未结算',5 => '已退单/已结算',2 => '已退单/未扣款',3 => '已退单/已扣款'),
        'lineCategory' => array('自发产品','采购产品'),
    ),
    ...
    'lineproductcategory' => array(0=>'基础分类', 1=>'主题分类', 2=>'活动分类'),
);